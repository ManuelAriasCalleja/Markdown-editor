...
// Descripción de un lenguaje para el resaltado: sus palabras clave y qué
...
// Registro de lenguajes: resuelve un alias (de la valla ```cpp, ```py, ...) a
...
// Devuelve la especificación del lenguaje. Para alias desconocidos o vacíos
