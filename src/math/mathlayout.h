...
/// \file
/// \brief Motor de maquetación 2D de fórmulas TeX: mide y pinta fracciones, raíces, matrices y grandes operadores.
...
/// \brief Motor de maquetación 2D de fórmulas TeX («Nivel 2»): convierte una expresión
...
/// \brief ¿La fórmula contiene construcciones que requieren maquetación 2D? Cierto si
...
/// \brief Tamaño que ocupa la fórmula `tex` maquetada en 2D con `baseFont` como tamaño
...
/// \brief Pinta la fórmula dentro de la caja cuyo extremo superior izquierdo es
