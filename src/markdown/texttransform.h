...
/// \file
/// \brief Transformaciones de texto sobre la selección (mayúsculas/minúsculas,
///        title case, ordenar líneas, tipografía inteligente).
...
/// \brief Devuelve `s` en mayúsculas.
QString toUpper(const QString &s);
/// \brief Devuelve `s` en minúsculas.
