...
/// \file
/// \brief Serialización canónica del documento a Markdown preservando la
///        alineación de columnas de las tablas.
...
/// Markdown del documento con la alineación de las tablas preservada. Es la ruta
/// de serialización canónica del proyecto (reinyecta tablas, fórmulas y
/// admoniciones).
