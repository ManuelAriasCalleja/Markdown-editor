...
- **Getrouwe round-trip**: wat je opent is wat je opslaat, met uitgelijnde tabellen,
  takenlijsten, citaten, codeblokken, voetnoten, admonities en formules.
- **Bewerking met tabbladen**: meerdere documenten tegelijk geopend, elk in zijn eigen
  tabblad.
...
- **Oogvriendelijk**: het *Warm nachtlicht* dempt het blauw van de achtergrond
  ...
  verminderen.
- **TeX-formules** met echte 2D-layout (gestapelde breuken, wortels, matrices,
  sommaties met grenzen…) en live voorbeeldweergave, zonder externe afhankelijkheden.
