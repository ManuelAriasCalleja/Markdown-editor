...
WYSIWYG-Editor/-Betrachter für Markdown in Qt6 + C++17. Standardmäßig bearbeitest du
den bereits gerenderten Text, ohne dich mit der Syntax herumzuschlagen; optional kannst
du aber auch den Markdown-Code ansehen und sogar Code und gerenderte Darstellung
nebeneinander haben (geteilte Ansicht) und auf beiden Seiten bearbeiten. Beim Speichern
wird stets sauberes Markdown serialisiert.
...
- [Installation](Instalacion-de)
- [Verwendung](Uso-de)
- [Funktionen](Caracteristicas-de)
- [Tastenkürzel](Atajos-de)
