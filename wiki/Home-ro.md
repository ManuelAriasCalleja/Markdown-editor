...
- **Round-trip fidel**: ceea ce deschizi este ceea ce salvezi, cu tabele aliniate,
  liste de sarcini, citate, blocuri de cod, note de subsol, avertismente și formule.
- **Editare pe file**: mai multe documente deschise simultan, fiecare în fila lui.
...
- **Formule TeX** cu *layout* 2D real (fracții stivuite, radicali, matrici,
  sumatorii cu limite…) și previzualizare în timp real, fără dependențe externe.
