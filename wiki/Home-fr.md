...
- **Round-trip fidèle** : ce que vous ouvrez est ce que vous enregistrez, avec des
  tableaux alignés, des listes de tâches, des citations, des blocs de code, des notes
  de bas de page, des admonitions et des formules.
- **Édition par onglets** : plusieurs documents ouverts en même temps, chacun dans
  son onglet.
...
- **Formules TeX** avec une vraie mise en page 2D (fractions empilées, racines,
  matrices, sommes avec limites…) et aperçu en direct, sans dépendances externes.
